...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose(
         [   
            # YOUR CODE HERE
            # First, resizing the image to 256
            transforms.Resize(256),
            # Randomly cropping the image to 224
            transforms.RandomCrop(224),
            # Applying horizontal flipping, as it's not included in RandAugment
            transforms.RandomHorizontalFlip(0.5),
            # Using RandAugment for additional data augmentation
